...
require_once('additional/phpmailer/PHPMailerAutoload.php');
$mail = new PHPMailer;
$mail->CharSet = 'utf-8';
...
$mail->setFrom('codeim@yandex.ru','Rollsbox.ru'); // от кого будет уходить письмо?
$mail->addAddress('codeim@yandex.ru');     // Кому будет уходить письмо
