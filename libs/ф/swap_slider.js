(function ( $ ) {
    ...
    $.swapSlider = function(selector,params){
        let CENTER_WIDTH = params == null || params.center_width == null ? 50 : params.center_width;
        let STEP_WIDTH = params == null || params.step_width == null ? 8 : params.step_width;
        let STEP_POS = params == null || params.step_pos == null ? 8 : params.step_pos;
        let CENTER_POS = (100 - CENTER_WIDTH) / 2;
        let ANIM_TIME = params == null || params.time == null ? 400 : params.time;
        ...
        $(selector).css({'height':$sliders.eq(center_index).height()+50});
        setTimeout(function (){
            $(selector).css({'height':$sliders.eq(center_index).height()+50});
        },450);
        $(window).resize(function(){
            $(selector).css({'height':$(selector+" > [data-index="+center_index+"]").height()+50});
        });
        ...
        $sliders.click(function(e){
            ...
            $sliders.removeClass("center-slide");
